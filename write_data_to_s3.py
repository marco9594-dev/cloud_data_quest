...
if __name__ == "__main__":
    ...
    mainfest_log_flile = config['bureau_labor_statistics_connection_info']['mainfest_log_file']
    ...
    print(sync_bls_files_to_s3(source_file_list, s3, aws_bucket_name, bls_s3_directory, mainfest_log_flile, bls_api_headers))

    response_data_usa_data = get_data_via_rest_api(data_usa_api_url)
    
    print(write_to_s3(s3, aws_bucket_name, f"{data_usa_s3_directory}/{data_usa_s3_file_name}", response_data_usa_data.text))